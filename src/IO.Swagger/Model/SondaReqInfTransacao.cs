...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SondaReqInfTransacao :  IEquatable<SondaReqInfTransacao>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SondaReqInfTransacao" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SondaReqInfTransacao() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SondaReqInfTransacao" /> class.
        /// </summary>
        ...
        public SondaReqInfTransacao(string dataLocal = default(string), string horaLocal = default(string), long? nsuSonda = default(long?), long? nsuTransacao = default(long?))
        {
            // to ensure "dataLocal" is required (not null)
            if (dataLocal == null)
            {
                throw new InvalidDataException("dataLocal is a required property for SondaReqInfTransacao and cannot be null");
            }
            else
            {
            ...
            if (horaLocal == null)
            {
                throw new InvalidDataException("horaLocal is a required property for SondaReqInfTransacao and cannot be null");
            }
            else
            {
            ...
            if (nsuSonda == null)
            {
                throw new InvalidDataException("nsuSonda is a required property for SondaReqInfTransacao and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("nsuTransacao is a required property for SondaReqInfTransacao and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as SondaReqInfTransacao);
        }

        /// <summary>
        /// Returns true if SondaReqInfTransacao instances are equal
        /// </summary>
        /// <param name="input">Instance of SondaReqInfTransacao to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SondaReqInfTransacao input)
        {
            if (input == null)
                return false;
